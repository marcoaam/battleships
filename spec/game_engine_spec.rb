...
describe Game do
	...
	it 'prompts for the player names when created' do
	...
	it 'prompts for the player to enter coordinates' do
		expect(game).to receive(:get_user_input).and_return("A1")
		game.get_coordinates
	end

	it 'prompts for the player to enter orientation' do
	...
	it 'prompts for the player to enter ship name' do
